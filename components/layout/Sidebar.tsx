...
export function Sidebar({ onClose }: { onClose?: () => void } = {}) {
  ...
  return (
    <aside style={{ width: 236, background: '#0f172a', display: 'flex', flexDirection: 'column', height: '100%' }}>
      {/* Brand */}
      <div style={{
        padding: '13px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)',
        display: 'flex', alignItems: 'center', gap: 9, flexShrink: 0
      }}>
        <div style={{
          width: 27, height: 27, borderRadius: 7, background: session?.org.logo_color ?? '#0d9488',
        ...
        <span style={{
          color: '#fff', fontWeight: 600, fontSize: 13, flex: 1, overflow: 'hidden',
      ...
      <nav style={{ flex: 1, overflowY: 'auto', padding: '8px 8px', scrollbarWidth: 'none' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', padding: '5px 10px 2px' }}>
          <button onClick={() => setProjectsOpen(p => !p)}
            style={{
              display: 'flex', alignItems: 'center', gap: 5, flex: 1, background: 'none',
      ...
      <div style={{ padding: '8px', borderTop: '1px solid rgba(255,255,255,0.08)', flexShrink: 0 }}>
        ...
        <Link href="/profile"
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{
              color: '#fff', fontSize: 12, fontWeight: 500, overflow: 'hidden',
              whiteSpace: 'nowrap', textOverflow: 'ellipsis'
            }}>{userName}</p>
            <p style={{
              color: 'rgba(255,255,255,0.35)', fontSize: 10, overflow: 'hidden',
              whiteSpace: 'nowrap', textOverflow: 'ellipsis'
