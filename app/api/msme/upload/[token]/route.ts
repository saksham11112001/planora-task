...
export async function POST(
  ...
  // Persist cert_url on the vendor record immediately (form submit will also send it)
  await admin.from('msme_vendors').update({ cert_url: certUrl }).eq('id', tokenRow.vendor_id)
