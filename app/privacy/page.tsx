...
export const metadata: Metadata = { title: 'Privacy Policy — upFloat' }
    ...
    <div style={{ minHeight:'100vh', background:'#f8fafb', fontFamily:"'Segoe UI',system-ui,sans-serif" }}>
      ...
      <main style={{ maxWidth:760, margin:'0 auto', padding:'60px 24px 100px' }}>
        ...
        <div style={{ background:'#fffbeb', border:'1px solid #fde68a', borderRadius:10, padding:'16px 20px', marginBottom:40, fontSize:14, color:'#92400e', lineHeight:1.7 }}>
          <strong>Plain-language summary:</strong> upFloat collects only what it needs to run the service, never sells your data, stores everything encrypted on enterprise-grade global infrastructure, and you can export or delete your data at any time.
        </div>
        ...
        {([
          ...
          },
          {
            ...
            body:`We use your data solely to provide, maintain, and improve upFloat — including sending transactional notifications, processing payments, and preventing abuse.<br/><br/>We do <strong>not</strong> use your data to train AI models, serve advertisements, or sell to third parties under any circumstances.`,
          },
          {
          ...
          {
            n:'8', title:'Cookies',
            body:'upFloat uses only a technically-necessary authentication session cookie. No advertising, tracking, or analytics cookies are set. No cookie banner is shown.',
          },
          {
