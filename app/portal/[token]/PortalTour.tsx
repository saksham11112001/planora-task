...
export default function PortalTour({ onDone }: Props) {
  ...
  function tooltipStyle(): React.CSSProperties {
    ...
    if (prefer === 'right')  return { position: 'fixed', top: Math.max(12, Math.min(midY - 80, vp.h - 180)), left: spotX + spotW + TOOLTIP_OFFSET, width: TOOLTIP_W, zIndex: 10001 }
    return { position: 'fixed', top: Math.max(12, Math.min(midY - 80, vp.h - 180)), right: vp.w - spotX + TOOLTIP_OFFSET, width: TOOLTIP_W, zIndex: 10001 }
  }
