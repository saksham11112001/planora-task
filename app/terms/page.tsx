...
export const metadata: Metadata = { title: 'Terms & Conditions — Planora' }
    ...
    <div style={{ minHeight:'100vh', background:'#f8fafb', fontFamily:"'Segoe UI',system-ui,sans-serif" }}>
      ...
      <main style={{ maxWidth:760, margin:'0 auto', padding:'60px 24px 100px' }}>
        ...
        <div style={{ background:'#fffbeb', border:'1px solid #fde68a', borderRadius:10, padding:'16px 20px', marginBottom:40, fontSize:14, color:'#92400e', lineHeight:1.7 }}>
          <strong>Plain-language summary:</strong> Use Planora for legitimate work purposes, don't misuse it, pay for your plan, and we will keep the service running reliably. Your data is yours — we are just the platform.
        </div>

        {([
          {
            n:'1', title:'Acceptance of Terms',
            body:'By accessing or using Planora ("the Service"), you agree to be bound by these Terms & Conditions. If you are using Planora on behalf of an organisation, you represent that you have authority to bind that organisation. If you do not agree, you must not use the Service.',
          },
          {
            n:'2', title:'Description of Service',
            body:'Planora is a task, project, and workflow management platform for professional teams. The Service includes web and mobile interfaces, a REST API, automated recurring tasks, time tracking, compliance workflow tools, and data import/export features. Features may vary by plan.',
          },
          {
...
Violation of this section may result in immediate account suspension without refund.`,
          ...
          },
          {
            ...
            body:'The Planora name, logo, product design, and code are the intellectual property of SNG Advisers and are protected by copyright and trademark law. You may not copy, modify, or distribute any part of the Service without our written consent.',
          },
          {
